...
const Cart = () => {
  ...
  return (
    ...
    <div className=" w-full mx-auto bg-white fixed z-10 top-10 right-0 py-12 text-black">
       <p className='text-orange-600 font-bold text-4xl text-center'>Items In the Cart</p> 
       ...
       if(cartItems[product.id]!==0){
        ...
        <div className='max-w-[1640px] m-auto px-4 py-12 text-center'>
          ...
          <button className='border-orange-500 bg-white text-black mx-2  bottom-4' onClick={() => navigate("/")}> Continue Shopping </button>
          <button
